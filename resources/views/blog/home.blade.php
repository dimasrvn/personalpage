	        ...
	        <div class="container tim-container">
	            ...
	            <div id="images">
	                ...
	                <div class="row">
						<div class="col-sm-2">
	                        <h4>Rounded Image</h4>
	                        <img src="{{ asset('/img/avatar.jpg') }}" alt="Rounded Image" class="img-rounded img-responsive">
	                    </div>
						<div class="col-sm-2 col-sm-offset-1">
	                        <h4>Circle Image</h4>
	                        <img src="{{ asset('/img/avatar.jpg') }}" alt="Circle Image" class="img-circle img-responsive">
	                    </div>
						<div class="col-sm-2 col-sm-offset-1">
	                        <h4>Rounded Raised</h4>
	                        <img src="{{ asset('/img/avatar.jpg') }}" alt="Raised Image" class="img-rounded img-responsive img-raised">
	                    </div>

	                    <div class="col-sm-2 col-sm-offset-1">
	                        <h4>Circle Raised</h4>
	                        <img src="{{ asset('/img/avatar.jpg') }}" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
	                    </div>
	                </div>
	                <div class="row">
							...
							<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
								<div class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										...
										<div class="item">
											<img src="{{ asset('img/bg3.jpeg') }}" alt="Awesome Image">
											<div class="carousel-caption">
												<h4><i class="material-icons">location_on</i> Somewhere Beyond, United States</h4>
											</div>
										</div>
										<div class="item">
											<img src="{{ asset('img/bg4.jpeg') }}" alt="Awesome Image">
											<div class="carousel-caption">
												<h4><i class="material-icons">location_on</i> Yellowstone National Park, United States</h4>
											</div>
										</div>
	            ...
	            <div class="row">
	                <div class="col-md-6">
	                    <a href="examples/landing-page.html" target="_blank">
	                        <img src="{{ asset('img/landing.jpg') }}" alt="Rounded Image" class="img-rounded img-raised img-responsive">
	                        <button class="btn  btn-simple btn-primary btn-lg">View Landing Page</button>
	                    </a>
	                </div>
	                <div class="col-md-6">
	                    <a href="examples/profile-page.html" target="_blank">
	                        <img src="{{ asset('img/profile.jpg') }}" alt="Rounded Image" class="img-rounded img-raised img-responsive">
